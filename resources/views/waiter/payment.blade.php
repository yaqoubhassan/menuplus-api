...
<div class="row justify-content-center">
    {{-- Page Title --}}
    <span class="text-light" style="font-size: 24px;">Payment</span>
</div>
<br>
<div class="row justify-content-center">
    <span class="text-warning h6"><i class="fas fa-circle"></i> Billed</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span class="text-success h6"><i class="fas fa-circle"></i> Paid</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span class="text-light h6"><i class="fas fa-circle"></i> Not-Billed</span>
</div>
<br>
