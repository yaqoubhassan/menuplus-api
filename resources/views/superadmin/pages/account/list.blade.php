...
@section('content')
      ...
      <div class="mt-5 flex justify-between space-x-10">
        <a href="{{route('superadmin.account.create')}}" class="w-2/12 btn btn-red no-underline hover:no-underline hover:text-white">Add New Account</a>
        ...
        <div class="text-darkAsh-50">
          <div class="grid grid-cols-5 gap-4">
            ...
            <div class="text-right flex space-x-8 justify-center">
              <a href="{{route('superadmin.account.edit', ['id' => '1'])}}" class="hover:no-underline no-underline hover:text-white">Edit</a>
