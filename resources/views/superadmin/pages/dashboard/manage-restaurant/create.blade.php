...
@section('content')
      @section('page-title', 'New Restaurant')
      <div class="flex justify-center">
        <div class="w-11/12 rounded-sm mt-5 mb-1 px-5 py-3 bg-darkAsh-300">
          ...
          <div class="text-center my-4">New Restaurant</div>
          <div class="grid grid-cols-2 gap-4">
            <input type="text" placeholder="Restaurant Name" class="input-field">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="grid grid-rows-2">
              ...
              <div class="grid grid-cols-5 gap-2  mt-2 text-darkAsh-50">
                <small>All</small>
                <small>Menu Plus</small>
                <small>Mis en Plus</small>
                <small>Static Report</small>
                <small>Reward Program</small>
              </div>
          ...
          <div class="mt-5 btn btn-red w-full py-2">
            Add
          </div>
        </div>
      </div>
